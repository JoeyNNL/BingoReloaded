...
public class BingoOptions {
	...
	public static final ConfigurationOption<String> DISCORD_BOT_TOKEN = new StringOptionAllowEmpty("discordBotToken");
	public static final ConfigurationOption<String> DISCORD_CHANNEL_ID = new StringOptionAllowEmpty("discordChannelId");
